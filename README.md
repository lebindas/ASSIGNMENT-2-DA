...
Duplicates- Used Condition formatting findout the duplicate and removed using Remove duplicate option on Data
Product ID- Separated date and country code using Right Function and Left function
